...
HD_PWD='D:/FPGA_DMA_CONTROLLER/proj/DMA_CTRL.runs/design_1_DMA_READ_CTRL_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_DMA_READ_CTRL_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_DMA_READ_CTRL_0_0.tcl
