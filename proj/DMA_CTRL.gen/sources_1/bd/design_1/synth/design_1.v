...
module design_1
   (READ_DATA_tdata,
    ...
    write_introut,
    write_start);
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 READ_DATA TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME READ_DATA, CLK_DOMAIN design_1_clk_0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [7:0]READ_DATA_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 READ_DATA TKEEP" *) output [0:0]READ_DATA_tkeep;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 READ_DATA TLAST" *) output READ_DATA_tlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 READ_DATA TREADY" *) input READ_DATA_tready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 READ_DATA TVALID" *) output READ_DATA_tvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 WRITE_DATA TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME WRITE_DATA, CLK_DOMAIN design_1_clk_0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [7:0]WRITE_DATA_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 WRITE_DATA TKEEP" *) input [0:0]WRITE_DATA_tkeep;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 WRITE_DATA TLAST" *) input WRITE_DATA_tlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 WRITE_DATA TREADY" *) output WRITE_DATA_tready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 WRITE_DATA TVALID" *) input WRITE_DATA_tvalid;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF WRITE_DATA:READ_DATA, ASSOCIATED_RESET rst_n, CLK_DOMAIN design_1_clk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input clk;
  input [31:0]read_byte_num;
  input [63:0]read_dest_addr;
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.READ_INTROUT INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.READ_INTROUT, PortWidth 1, SENSITIVITY LEVEL_HIGH" *) output read_introut;
  input read_start;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.WRITE_INTROUT INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.WRITE_INTROUT, PortWidth 1, SENSITIVITY LEVEL_HIGH" *) output write_introut;
  input write_start;

  wire [9:0]DMA_READ_CTRL_0_m_axi_lite_ARADDR;
  wire DMA_READ_CTRL_0_m_axi_lite_ARREADY;
  wire DMA_READ_CTRL_0_m_axi_lite_ARVALID;
  wire [9:0]DMA_READ_CTRL_0_m_axi_lite_AWADDR;
  wire DMA_READ_CTRL_0_m_axi_lite_AWREADY;
  wire DMA_READ_CTRL_0_m_axi_lite_AWVALID;
  wire DMA_READ_CTRL_0_m_axi_lite_BREADY;
  wire [1:0]DMA_READ_CTRL_0_m_axi_lite_BRESP;
  wire DMA_READ_CTRL_0_m_axi_lite_BVALID;
  wire [31:0]DMA_READ_CTRL_0_m_axi_lite_RDATA;
  wire DMA_READ_CTRL_0_m_axi_lite_RREADY;
  wire [1:0]DMA_READ_CTRL_0_m_axi_lite_RRESP;
  wire DMA_READ_CTRL_0_m_axi_lite_RVALID;
  wire [31:0]DMA_READ_CTRL_0_m_axi_lite_WDATA;
  wire DMA_READ_CTRL_0_m_axi_lite_WREADY;
  wire DMA_READ_CTRL_0_m_axi_lite_WVALID;
  wire [9:0]DMA_WRITE_CTRL_0_m_axi_lite_ARADDR;
  wire DMA_WRITE_CTRL_0_m_axi_lite_ARREADY;
  wire DMA_WRITE_CTRL_0_m_axi_lite_ARVALID;
  wire [9:0]DMA_WRITE_CTRL_0_m_axi_lite_AWADDR;
  wire DMA_WRITE_CTRL_0_m_axi_lite_AWREADY;
  wire DMA_WRITE_CTRL_0_m_axi_lite_AWVALID;
  wire DMA_WRITE_CTRL_0_m_axi_lite_BREADY;
  wire [1:0]DMA_WRITE_CTRL_0_m_axi_lite_BRESP;
  wire DMA_WRITE_CTRL_0_m_axi_lite_BVALID;
  wire [31:0]DMA_WRITE_CTRL_0_m_axi_lite_RDATA;
  wire DMA_WRITE_CTRL_0_m_axi_lite_RREADY;
  wire [1:0]DMA_WRITE_CTRL_0_m_axi_lite_RRESP;
  wire DMA_WRITE_CTRL_0_m_axi_lite_RVALID;
  wire [31:0]DMA_WRITE_CTRL_0_m_axi_lite_WDATA;
  wire DMA_WRITE_CTRL_0_m_axi_lite_WREADY;
  wire DMA_WRITE_CTRL_0_m_axi_lite_WVALID;
  ...
  wire [31:0]byte_num_0_1;
  wire [31:0]byte_num_0_2;
  wire clk_0_1;
  wire [63:0]dest_addr_0_1;
  wire [63:0]dest_addr_0_2;
  wire rst_n_1;
  wire start_0_1;
  wire start_0_2;
  wire [0:0]util_vector_logic_0_Res;

  assign READ_DATA_tdata[7:0] = axi_dma_0_M_AXIS_MM2S_TDATA;
  assign READ_DATA_tkeep[0] = axi_dma_0_M_AXIS_MM2S_TKEEP;
  assign READ_DATA_tlast = axi_dma_0_M_AXIS_MM2S_TLAST;
  assign READ_DATA_tvalid = axi_dma_0_M_AXIS_MM2S_TVALID;
  assign S_AXIS_S2MM_0_1_TDATA = WRITE_DATA_tdata[7:0];
  assign S_AXIS_S2MM_0_1_TKEEP = WRITE_DATA_tkeep[0];
  assign S_AXIS_S2MM_0_1_TLAST = WRITE_DATA_tlast;
  assign S_AXIS_S2MM_0_1_TVALID = WRITE_DATA_tvalid;
  assign WRITE_DATA_tready = S_AXIS_S2MM_0_1_TREADY;
  assign axi_dma_0_M_AXIS_MM2S_TREADY = READ_DATA_tready;
  assign byte_num_0_1 = read_byte_num[31:0];
  assign byte_num_0_2 = write_byte_num[31:0];
  assign clk_0_1 = clk;
  assign dest_addr_0_1 = read_dest_addr[63:0];
  assign dest_addr_0_2 = write_dest_addr[63:0];
  assign read_introut = axi_dma_0_mm2s_introut;
  assign rst_n_1 = rst_n;
  assign start_0_1 = read_start;
  assign start_0_2 = write_start;
  assign write_introut = axi_dma_1_s2mm_introut;
  design_1_DMA_READ_CTRL_0_0 DMA_READ_CTRL_0
       (.byte_num(byte_num_0_1),
        .clk(clk_0_1),
        .dest_addr(dest_addr_0_1),
        .m_axi_lite_araddr(DMA_READ_CTRL_0_m_axi_lite_ARADDR),
        .m_axi_lite_arready(DMA_READ_CTRL_0_m_axi_lite_ARREADY),
        .m_axi_lite_arvalid(DMA_READ_CTRL_0_m_axi_lite_ARVALID),
        .m_axi_lite_awaddr(DMA_READ_CTRL_0_m_axi_lite_AWADDR),
        .m_axi_lite_awready(DMA_READ_CTRL_0_m_axi_lite_AWREADY),
        .m_axi_lite_awvalid(DMA_READ_CTRL_0_m_axi_lite_AWVALID),
        .m_axi_lite_bready(DMA_READ_CTRL_0_m_axi_lite_BREADY),
        .m_axi_lite_bresp(DMA_READ_CTRL_0_m_axi_lite_BRESP),
        .m_axi_lite_bvalid(DMA_READ_CTRL_0_m_axi_lite_BVALID),
        .m_axi_lite_rdata(DMA_READ_CTRL_0_m_axi_lite_RDATA),
        .m_axi_lite_rready(DMA_READ_CTRL_0_m_axi_lite_RREADY),
        .m_axi_lite_rresp(DMA_READ_CTRL_0_m_axi_lite_RRESP),
        .m_axi_lite_rvalid(DMA_READ_CTRL_0_m_axi_lite_RVALID),
        .m_axi_lite_wdata(DMA_READ_CTRL_0_m_axi_lite_WDATA),
        .m_axi_lite_wready(DMA_READ_CTRL_0_m_axi_lite_WREADY),
        .m_axi_lite_wvalid(DMA_READ_CTRL_0_m_axi_lite_WVALID),
        .mm2s_introut(axi_dma_0_mm2s_introut),
        .rst(util_vector_logic_0_Res),
        .start(start_0_1));
  design_1_DMA_WRITE_CTRL_0_0 DMA_WRITE_CTRL_0
       (.byte_num(byte_num_0_2),
        .clk(clk_0_1),
        .dest_addr(dest_addr_0_2),
        .m_axi_lite_araddr(DMA_WRITE_CTRL_0_m_axi_lite_ARADDR),
        .m_axi_lite_arready(DMA_WRITE_CTRL_0_m_axi_lite_ARREADY),
        .m_axi_lite_arvalid(DMA_WRITE_CTRL_0_m_axi_lite_ARVALID),
        .m_axi_lite_awaddr(DMA_WRITE_CTRL_0_m_axi_lite_AWADDR),
        .m_axi_lite_awready(DMA_WRITE_CTRL_0_m_axi_lite_AWREADY),
        .m_axi_lite_awvalid(DMA_WRITE_CTRL_0_m_axi_lite_AWVALID),
        .m_axi_lite_bready(DMA_WRITE_CTRL_0_m_axi_lite_BREADY),
        .m_axi_lite_bresp(DMA_WRITE_CTRL_0_m_axi_lite_BRESP),
        .m_axi_lite_bvalid(DMA_WRITE_CTRL_0_m_axi_lite_BVALID),
        .m_axi_lite_rdata(DMA_WRITE_CTRL_0_m_axi_lite_RDATA),
        .m_axi_lite_rready(DMA_WRITE_CTRL_0_m_axi_lite_RREADY),
        .m_axi_lite_rresp(DMA_WRITE_CTRL_0_m_axi_lite_RRESP),
        .m_axi_lite_rvalid(DMA_WRITE_CTRL_0_m_axi_lite_RVALID),
        .m_axi_lite_wdata(DMA_WRITE_CTRL_0_m_axi_lite_WDATA),
        .m_axi_lite_wready(DMA_WRITE_CTRL_0_m_axi_lite_WREADY),
        .m_axi_lite_wvalid(DMA_WRITE_CTRL_0_m_axi_lite_WVALID),
        .rst(util_vector_logic_0_Res),
  ...
  design_1_axi_dma_0_0 axi_dma_0
       (.axi_resetn(rst_n_1),
        ...
        .s_axi_lite_araddr(DMA_READ_CTRL_0_m_axi_lite_ARADDR),
        .s_axi_lite_arready(DMA_READ_CTRL_0_m_axi_lite_ARREADY),
        .s_axi_lite_arvalid(DMA_READ_CTRL_0_m_axi_lite_ARVALID),
        .s_axi_lite_awaddr(DMA_READ_CTRL_0_m_axi_lite_AWADDR),
        .s_axi_lite_awready(DMA_READ_CTRL_0_m_axi_lite_AWREADY),
        .s_axi_lite_awvalid(DMA_READ_CTRL_0_m_axi_lite_AWVALID),
        .s_axi_lite_bready(DMA_READ_CTRL_0_m_axi_lite_BREADY),
        .s_axi_lite_bresp(DMA_READ_CTRL_0_m_axi_lite_BRESP),
        .s_axi_lite_bvalid(DMA_READ_CTRL_0_m_axi_lite_BVALID),
        .s_axi_lite_rdata(DMA_READ_CTRL_0_m_axi_lite_RDATA),
        .s_axi_lite_rready(DMA_READ_CTRL_0_m_axi_lite_RREADY),
        .s_axi_lite_rresp(DMA_READ_CTRL_0_m_axi_lite_RRESP),
        .s_axi_lite_rvalid(DMA_READ_CTRL_0_m_axi_lite_RVALID),
        .s_axi_lite_wdata(DMA_READ_CTRL_0_m_axi_lite_WDATA),
        .s_axi_lite_wready(DMA_READ_CTRL_0_m_axi_lite_WREADY),
        .s_axi_lite_wvalid(DMA_READ_CTRL_0_m_axi_lite_WVALID));
  design_1_axi_dma_1_0 axi_dma_1
       (.axi_resetn(rst_n_1),
        ...
        .s2mm_introut(axi_dma_1_s2mm_introut),
        .s_axi_lite_aclk(clk_0_1),
        .s_axi_lite_araddr(DMA_WRITE_CTRL_0_m_axi_lite_ARADDR),
        .s_axi_lite_arready(DMA_WRITE_CTRL_0_m_axi_lite_ARREADY),
        .s_axi_lite_arvalid(DMA_WRITE_CTRL_0_m_axi_lite_ARVALID),
        .s_axi_lite_awaddr(DMA_WRITE_CTRL_0_m_axi_lite_AWADDR),
        .s_axi_lite_awready(DMA_WRITE_CTRL_0_m_axi_lite_AWREADY),
        .s_axi_lite_awvalid(DMA_WRITE_CTRL_0_m_axi_lite_AWVALID),
        .s_axi_lite_bready(DMA_WRITE_CTRL_0_m_axi_lite_BREADY),
        .s_axi_lite_bresp(DMA_WRITE_CTRL_0_m_axi_lite_BRESP),
        .s_axi_lite_bvalid(DMA_WRITE_CTRL_0_m_axi_lite_BVALID),
        .s_axi_lite_rdata(DMA_WRITE_CTRL_0_m_axi_lite_RDATA),
        .s_axi_lite_rready(DMA_WRITE_CTRL_0_m_axi_lite_RREADY),
        .s_axi_lite_rresp(DMA_WRITE_CTRL_0_m_axi_lite_RRESP),
        .s_axi_lite_rvalid(DMA_WRITE_CTRL_0_m_axi_lite_RVALID),
        .s_axi_lite_wdata(DMA_WRITE_CTRL_0_m_axi_lite_WDATA),
        .s_axi_lite_wready(DMA_WRITE_CTRL_0_m_axi_lite_WREADY),
        .s_axi_lite_wvalid(DMA_WRITE_CTRL_0_m_axi_lite_WVALID),
...
module m00_couplers_imp_1CA5Z32
  ...
  wire [63:0]m00_data_fifo_to_m00_couplers_RDATA;
  ...
  wire [63:0]m00_data_fifo_to_m00_couplers_WDATA;
  wire m00_data_fifo_to_m00_couplers_WLAST;
  wire m00_data_fifo_to_m00_couplers_WREADY;
  wire [7:0]m00_data_fifo_to_m00_couplers_WSTRB;
  ...
  assign M_AXI_wdata[63:0] = m00_data_fifo_to_m00_couplers_WDATA;
  assign M_AXI_wlast = m00_data_fifo_to_m00_couplers_WLAST;
  assign M_AXI_wstrb[7:0] = m00_data_fifo_to_m00_couplers_WSTRB;
  ...
  assign m00_data_fifo_to_m00_couplers_RDATA = M_AXI_rdata[63:0];
