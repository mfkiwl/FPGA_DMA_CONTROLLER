...
--               d:/FPGA_DMA_CONTROLLER/proj/DMA_CTRL.gen/sources_1/bd/design_1/ip/design_1_DMA_READ_CTRL_0_0/design_1_DMA_READ_CTRL_0_0_sim_netlist.vhdl
...
entity design_1_DMA_READ_CTRL_0_0_LITE_CTRL is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_DMA_READ_CTRL_0_0_LITE_CTRL : entity is "LITE_CTRL";
end design_1_DMA_READ_CTRL_0_0_LITE_CTRL;

architecture STRUCTURE of design_1_DMA_READ_CTRL_0_0_LITE_CTRL is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_DMA_READ_CTRL_0_0_MM2S_CTRL is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_DMA_READ_CTRL_0_0_MM2S_CTRL : entity is "MM2S_CTRL";
end design_1_DMA_READ_CTRL_0_0_MM2S_CTRL;

architecture STRUCTURE of design_1_DMA_READ_CTRL_0_0_MM2S_CTRL is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \current_state[3]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \current_state[5]_i_1\ : label is "soft_lutpair7";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of lite_valid_q_i_3 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of lite_valid_q_i_5 : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \lite_wdata[2]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \lite_wdata[31]_i_2\ : label is "soft_lutpair6";
...
lite_valid_q_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"70000000"
    )
        port map (
...
lite_valid_q_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE00"
    )
        port map (
...
lite_valid_q_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"70"
    )
        port map (
...
lite_valid_q_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"08000000"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_DMA_READ_CTRL_0_0_DMA_READ_CTRL is
  port (
    m_axi_lite_wdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    m_axi_lite_awaddr : out STD_LOGIC_VECTOR ( 3 downto 0 );
    m_axi_lite_bready : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_DMA_READ_CTRL_0_0_DMA_READ_CTRL : entity is "DMA_READ_CTRL";
end design_1_DMA_READ_CTRL_0_0_DMA_READ_CTRL;

architecture STRUCTURE of design_1_DMA_READ_CTRL_0_0_DMA_READ_CTRL is
...
u_LITE_CTRL: entity work.design_1_DMA_READ_CTRL_0_0_LITE_CTRL
     port map (
      clk => clk,
      lite_end => lite_end,
...
u_MM2S_CTRL: entity work.design_1_DMA_READ_CTRL_0_0_MM2S_CTRL
     port map (
      Q(31 downto 0) => SA(31 downto 0),
      clk => clk,
      lite_end => lite_end,
      lite_valid => lite_valid,
...
entity design_1_DMA_READ_CTRL_0_0 is
  ...
  attribute NotValidForBitStream of design_1_DMA_READ_CTRL_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_DMA_READ_CTRL_0_0 : entity is "design_1_DMA_READ_CTRL_0_0,DMA_READ_CTRL,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_DMA_READ_CTRL_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_DMA_READ_CTRL_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_DMA_READ_CTRL_0_0 : entity is "DMA_READ_CTRL,Vivado 2020.2";
end design_1_DMA_READ_CTRL_0_0;

architecture STRUCTURE of design_1_DMA_READ_CTRL_0_0 is
...
inst: entity work.design_1_DMA_READ_CTRL_0_0_DMA_READ_CTRL
     port map (
